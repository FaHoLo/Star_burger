...
![скриншот страницы менеджера](examples/manager.jpg)
...
Код написан в учебных целях совместно с [Devman](https://dvmn.org). За основу был взят код проекта [FoodCart](https://github.com/Saibharath79/FoodCart).
